...
export const TermOfService: React.FC = () => {
  return (
    <div>
      ...
      <p>Welcome to SciHive!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of www.scihive.org's Website, located
        at https://www.scihive.org.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use SciHive if you
      ...
      <p>
        We employ the use of cookies. By accessing SciHive, you agreed to use cookies in agreement with the
        www.scihive.org's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, www.scihive.org and/or its licensors own the intellectual property rights for all
        material on SciHive. All intellectual property rights are reserved. You may access this from SciHive for your
        own personal use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from SciHive</li>
        <li>Sell, rent or sub-license material from SciHive</li>
        <li>Reproduce, duplicate or copy material from SciHive</li>
        <li>Redistribute content from SciHive</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. www.scihive.org does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of www.scihive.org,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, www.scihive.org shall not be liable for the Comments or for any liability, damages or
        expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
        this website.
      </p>

      <p>
        www.scihive.org reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant www.scihive.org a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p>
        ...
        www.scihive.org; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to www.scihive.org. Please include your name, your organization name,
      ...
      <p>
        No use of www.scihive.org's logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
