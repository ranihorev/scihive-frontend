  ...
  return (
    <React.Fragment>
      ...
      <div className={baseStyles.legalDocs}>
        ...
        <p>
          At SciHive, accessible from https://www.scihive.org, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information that is collected and recorded by SciHive
          and how we use it.
        </p>
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in SciHive. This policy is not applicable to any
        ...
        <p>
          SciHive follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        <p>
          Like any other website, SciHive uses 'cookies'. These cookies are used to store information including
        ...
        <p>
          ...
          in their respective advertisements and links that appear on SciHive, which are sent directly to users'
        ...
        <p>
          Note that SciHive has no access to or control over these cookies that are used by third-party advertisers.
        </p>
