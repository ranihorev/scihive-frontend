  ...
  return (
    <React.Fragment>
      ...
      <div className={baseStyles.legalDocs}>
        ...
        <p>
          By accessing this website we assume you accept these terms and conditions. Do not continue to use SciHive if
        ...
        <p>
          ...
          areas of the website. www.scihive.org does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of www.scihive.org,its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, www.scihive.org shall not be liable for the Comments or for any
