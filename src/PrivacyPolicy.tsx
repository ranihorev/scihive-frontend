...
export const PrivacyPolicy: React.FC = () => {
  return (
    <div className={baseStyles.legalDocs}>
      ...
      <p>
        At SciHive, accessible from https://www.scihive.org, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains types of information that is collected and recorded by SciHive and how we
        use it.
      </p>
      ...
      <p>
        ...
        to the information that they shared and/or collect in SciHive. This policy is not applicable to any information
      ...
      <p>
        SciHive follows a standard procedure of using log files. These files log visitors when they visit websites. All
      ...
      <p>
        Like any other website, SciHive uses 'cookies'. These cookies are used to store information including visitors'
      ...
      <p>You may consult this list to find the Privacy Policy for each of the advertising partners of SciHive.</p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on SciHive, which are sent directly to users' browser.
      ...
      <p>Note that SciHive has no access to or control over these cookies that are used by third-party advertisers.</p>

      <h2>Third Party Privacy Policies</h2>

      <p>
        SciHive's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
      ...
      <p>
        SciHive does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
      ...
      <p>
        ...
        <a href="https://www.privacypolicyonline.com/privacy-policy-generator/">Free Privacy Policy Generator</a>.
      </p>
    </div>
  );
};
